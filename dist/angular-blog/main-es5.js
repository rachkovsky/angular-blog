...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var redirectUnauthorizedToLogin = function () { return Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_10__["redirectUnauthorizedTo"])(['login']); };
            var appRoutes = [
                {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminComponent = /** @class */ (function () {
                ...
                AdminComponent.prototype.ngOnInit = function () {
                    ...
                    }); })).subscribe(function (blogInfo) {
                        _this.blogInfo = blogInfo[0];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArticlePreviewListComponent = /** @class */ (function () {
                function ArticlePreviewListComponent(route) {
                    this.route = route;
                }
                ...
                ArticlePreviewListComponent.prototype.onArticleDelete = function (id) {
                    console.log('onArticleDelete: ', id);
                    this.articlePreviewlist = this.articlePreviewlist.filter(function (item) {
                        return item.id !== id;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArticlePreviewComponent = /** @class */ (function () {
                function ArticlePreviewComponent(articleService) {
                    this.articleService = articleService;
                    this.delete = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                ArticlePreviewComponent.prototype.ngOnInit = function () {
                };
                ArticlePreviewComponent.prototype.deleteArticle = function (id) {
                    var _this = this;
                    this.articleService.deleteArticle(id)
                        .then(function (res) {
                        console.log(res);
                        _this.delete.emit(id);
                    })
                        .catch(function (err) {
                        console.log('Error: ', err);
                    });
                };
                ArticlePreviewComponent.prototype.editArticle = function () {
                    //TBD....
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgIfAdminDirective = /** @class */ (function () {
                ...
                NgIfAdminDirective.prototype.ngOnDestroy = function () {
            ...
            var DaysAgoPipe = /** @class */ (function () {
                ...
                DaysAgoPipe.prototype.transform = function (value) {
                    ...
                    if (value) {
                        ...
                        var counter = void 0;
                        for (var _a = 0, _b = Object.keys(intervals); _a < _b.length; _a++) {
                            var i = _b[_a];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArticleListResolverService = /** @class */ (function () {
                function ArticleListResolverService(articleService) {
                    this.articleService = articleService;
                }
                ArticleListResolverService.prototype.resolve = function () {
                    return this.articleService.getArticles().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1));
                };
                return ArticleListResolverService;
            }());
            ArticleListResolverService.ctorParameters = function () { return [
                { type: _services_article_article_service__WEBPACK_IMPORTED_MODULE_2__["ArticleService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_article_article_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/article/article.service */ "./src/app/services/article/article.service.ts");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var ArticleResolverService = /** @class */ (function () {
                function ArticleResolverService(articleService) {
                    this.articleService = articleService;
                }
                ArticleResolverService.prototype.resolve = function (route) {
            ...
            ArticleResolverService.ctorParameters = function () { return [
                { type: _services_article_article_service__WEBPACK_IMPORTED_MODULE_2__["ArticleService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArticleService = /** @class */ (function () {
                ...
                ArticleService.prototype.getArticles = function () {
                    return this.db.collection('articles').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) { return actions.map(function (a) {
                        var data = a.payload.doc.data();
                        var id = a.payload.doc.id;
                        return Object.assign({ id: id }, data);
                    }); }));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                function AuthService(afAuth, router) {
                    this.afAuth = afAuth;
                    this.router = router;
                    this.user$ = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (data) {
                ...
                AuthService.prototype.login = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.afAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_4__["auth"].GoogleAuthProvider())];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
